...
from app.models.sql_models import AgentMetrics, TestScenario, AIResponse
            ...
            async with get_session() as session:
                ...
                for ai_type in ai_types:
                    for test_type in test_types:
                        ...
                        recent_scenarios = [s for s in scenarios if hasattr(s, 'ai_type') and s.ai_type == ai_type and hasattr(s, 'test_type') and s.test_type == test_type]
            ...
            async with get_session() as session:
                ...
                for scenario in scenarios:
                    backup_data["test_scenarios"].append({
                        ...
                        "ai_type": getattr(scenario, 'ai_type', 'unknown'),
                        "scenario_data": getattr(scenario, 'scenario_data', {}),
