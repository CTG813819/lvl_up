#!/usr/bin/env python3
"""
Fix for the nested except Exception block on line 1828 in custody_protocol_service.py
"""

def fix_custody_nested_except_1828():
    """Fix the nested except Exception block on line 1828"""
    ...
    # The corrected pattern - remove the nested except block
    ...
    if old_pattern in content:
        ...
        print("Fixed nested except Exception block on line 1828")
    else:
        ...
        while i < len(lines):
            ...
            if ('except AttributeError as e:' in line and 
                ...
                # Skip the nested except block and add the correct one
                i += 3
        ...
        with open('app/services/custody_protocol_service.py', 'w', encoding='utf-8') as f:
            f.write('\n'.join(fixed_lines))
        print("Fixed nested except Exception block using line-by-line approach")
        return
...
if __name__ == "__main__":
    fix_custody_nested_except_1828()