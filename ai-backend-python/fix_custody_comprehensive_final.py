#!/usr/bin/env python3
"""
Comprehensive fix for the syntax error around line 1449 in custody_protocol_service.py
"""

def fix_custody_comprehensive_final():
    """Fix the entire problematic section around line 1449"""
    
    # Read the file
    with open('app/services/custody_protocol_service.py', 'r', encoding='utf-8') as f:
        content = f.read()
    
    # The problematic section that needs to be fixed
    old_pattern = '''                pass
    ...
    if old_pattern in content:
        ...
        print("Fixed comprehensive syntax error around line 1449")
    else:
        print("Pattern not found. Trying alternative approach...")
        
        # Alternative approach: find and fix the specific problematic lines
        lines = content.split('\n')
        fixed_lines = []
        i = 0
...
if __name__ == "__main__":
    fix_custody_comprehensive_final()