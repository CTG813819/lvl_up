...
def run_comprehensive_test():
    ...
    if invalid_extension_id:
        invalid_extension = wait_for_testing_completion(invalid_extension_id)
    
    # Test 5: Approve valid extension
    print("\n📝 Test 5: Approve valid extension")
    if valid_extension_id:
        approval_success = test_extension_approval(valid_extension_id)
    
    # Test 6: Retrieve approved extensions
    print("\n📝 Test 6: Retrieve approved extensions")
    ...
    print("\n📝 Test 7: Final verification")
    if valid_extension_id:
        final_extension = test_extension_retrieval(valid_extension_id)
        if final_extension and final_extension['status'] == 'approved':
...
if __name__ == "__main__":
    try:
        ...
        if success:
            print("\n🎉 All Terra extensions tests passed!")
            sys.exit(0)
        else:
            print("\n❌ Some tests failed!")
            sys.exit(1)
