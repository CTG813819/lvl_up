...
void main() async {
  ...
  try {
    ...
    print(
      '   ✅ Basic connectivity: ${response.statusCode == 200 || response.statusCode == 404 ? "SUCCESS" : "FAILED"}',
    );
    ...
    for (final endpoint in endpoints) {
      try {
        final apiRequest = await client.getUrl(
    ...
    try {
      ...
      if (healthResponse.statusCode == 200) {
        ...
        print(
          '   ⚠️ Backend health check: Status ${healthResponse.statusCode}',
        );
      }
    } catch (e) {
