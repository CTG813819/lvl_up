...
# Enhanced services
app.include_router(enhanced_learning.router, prefix="/api/enhanced-learning", tags=["Enhanced Learning"])
app.include_router(terra_extensions.router, prefix="/api/terra-extensions", tags=["Terra Extensions"])
app.include_router(training_data.router, prefix="/api/training-data", tags=["Training Data"])
app.include_router(anthropic_test.router, prefix="/api/anthropic-test", tags=["Anthropic Test"])
app.include_router(optimized_services.router, prefix="/api/optimized-services", tags=["Optimized Services"])
app.include_router(token_usage.router, prefix="/api/token-usage", tags=["Token Usage"])
app.include_router(weekly_notifications.router, prefix="/api/weekly-notifications", tags=["Weekly Notifications"])
app.include_router(custody_protocol.router, prefix="/api/custody", tags=["Custody Protocol"])
app.include_router(black_library.router, prefix="/api/black-library", tags=["Black Library"])
app.include_router(imperium_extensions.router, prefix="/api/imperium-extensions", tags=["Imperium Extensions"])
